...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
   var getPizzCount = function() {
      var am = Math.max(document.documentElement.clientHeight, window.innerHeight || 0);
      return Math.round(am / 4 / 8);
    };
    var pizzC = getPizzCount();

  for (var i = 0; i < pizzC; i++) {
